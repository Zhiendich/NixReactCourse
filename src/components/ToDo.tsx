...
const ToDo = ({
  ...
  return (
    <div
      className={
        status === "Done"
          ? "done flex items-center bg-[#C5E1E5] border-[2px] border-[black] p-3 mb-3 justify-between"
          : "flex items-center bg-[#C5E1E5] border-[2px] border-[black] p-3 mb-3 justify-between"
      }>
      ...
      <div
        onClick={changeTodo}
        className="z-10 bg-[#1D1BA4] block w-[30px] h-[30px] rounded-md text-center cursor-pointer">
        <svg
          fill="white"
