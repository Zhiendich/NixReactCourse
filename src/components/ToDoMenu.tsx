...
const ToDoMenu = () => {
  ...
  return (
    <div className="max-w-[1200px] w-full min-h-[400px] bg-white rounded-2xl p-4 relative">
      ...
      {todos.length === 0 && (
        <h1 className="text-center text-[bold] text-[40px]">
          Пора записать новые дела!
        </h1>
      )}
      <div className="absolute bottom-[10px] flex justify-between w-[90%]">
        <select
          ...
          className="border-[#2261CB] border-[2px] rounded-xl outline-none p-1 mt-3 inline-block align-bottom">
          <option>All</option>
          <option>Open</option>
